...
public class CompletedOrderUtils extends PendingOrderUtils {
    String path;
    private DatabaseReference mRef;
    private ChildEventListener mChildEventListener;
    private static int totalCompletedOrder = 0;
    ...
    public CompletedOrderUtils(){}

    public CompletedOrderUtils(String email){
        path = "Users/"+email+"/CompletedOrders";
    ...
    public int getCount(){
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                totalCompletedOrder = (int) snapshot.getChildrenCount();
            }
